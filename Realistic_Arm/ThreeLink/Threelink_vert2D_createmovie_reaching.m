...
function M = Threelink_vert2D_createmovie_reaching(x,t,fps_des,len,x_target)
...
for i = 1:length(frame_index)
    ...
    %plot(l1*cos(x_target(1))+l2*cos(x_target(1)+x_target(2)),l1*sin(x_target(1))+l2*sin(x_target(1)+x_target(2)),'*');
    plot(l1*cos(x_target(1))+l2*cos(x_target(1)+x_target(2))+l3*cos(x_target(1)+x_target(2)+x_target(3)),l1*sin(x_target(1))+l2*sin(x_target(1)+x_target(2))+l3*sin(x_target(1)+x_target(2)+x_target(3)),'*');
    hold off
